...
const seedTest = async () => {
    const firstShirt = await Article.create({
        name : "first shirt",
        creator : "Nathan",
        type : "shirt",
        color : "",
    ...
    const firstPants = await Article.create({
        name : "first pants",
        creator : "Nathan",
        type : "pants",
        color : "",
    ...
    const firstHat = await Article.create({
        name : "first hat",
        creator : "Kenneth",
        type : "hat",
        color : "",
    ...
    const secondOA = await OutfitArticle.create({
        article_id :  2,
        outfit_id: 1
    })

    const thirdOA = await OutfitArticle.create({
        article_id :  3,
        outfit_id: 1
    })

   
    // await firstOutfit.setArticle(firstHat)
    // await firstOutfit.setArticle(firstShirt)
    // await firstOutfit.setArticle(firstPants)


    // await secondOutfit.setHat(firstHat)
    // await secondOutfit.setShirt(firstShirt)
    // await secondOutfit.setPants(firstPants)
}
